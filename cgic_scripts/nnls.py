"""
This is an extension of scikit-learn that allows for non-negative
coefficients for a linear regression. All the rest of the setup is
standard.

Ganked from https://github.com/scikit-learn/scikit-learn/pull/8428
